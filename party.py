...
def is_mel(name, email):
    """Is this user Mel?
        ...
        >>> is_mel("Sumaiya Talukdar", "talukdar.sumaiya@gmail.com")
        False

        >>> is_mel("Mel Melitpolski", "test@email.com")
        True

        >>> is_mel("Test Name", "mel@ubermelon.com")
        True
...
def most_and_least_common_type(treats):
    ...
    most_count = most_type = least_count = least_type = None
